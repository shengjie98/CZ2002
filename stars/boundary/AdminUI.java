...
public class AdminUI extends SelectUI {
    ...
    // // degree, email)
    // if (adminController.addStudent(studentName, nationality, gender, studentID,
    // degree, email, password, start,
    // end)) {
    ...
    // Index newIndex = adminController.createIndex(newCourse, newVacancy,
    // newIndexNumber);
    ...
    // } else {
    // System.out.println("Timing could not be added! There was a clash in
    // timing.");
    // }
    ...
    // Course newCourse = adminController.createCourse(newCourseID, newAU,
    // newSchool, newCourseName);
    ...
    // } else {
    // System.out.println("Unable to drop Index. Students are already in the
    // Index!");
    // }
    // break;
    // }
    ...
    // } else {
    // System.out.println("Unable to change Index ID. An Index with the same ID
    // already exists!");
    // }
    // break;
    // }
    ...
    // System.out.println("Unable to set new vacancy. Students will be kicked out of
    // the list!");
    // }
    // break;
    // }
