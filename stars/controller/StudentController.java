...
public class StudentController {
    ...
    /**
     * Drops an Index from the Student's StudentRegisteredCourses and removes student from the Index
     * @param index Index tht the student is dropping
     * @return Boolean that indicates true if student is dropped from confirm list, false if student is dropped from waitlist
     */
    ...
    /**
     * Getter method to get a full list of all indexes that student has registered for
    ...
    /**
     * Getter method to get a full list of all indexes that student has been confirmed for
    ...
    /**
     * Getter method to get a full list of all indexes that student has added to waitlist for
     * @return ArrayList containing all Indexes that student has added to waitlist for
     */
     ...
     * @return Boolean that indicates true if Student has been added to the confirmed list of the new Index, false if the Student is added to the waitlist
