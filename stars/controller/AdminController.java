...
public class AdminController {
     ...
     * @return true if there is no overlap with exisiting timing object in the Index, the timing would be successfully added. false if there is an overlap with exisiting timing object in Index. Timing will not be added
     */
     ...
     * @return true if new Student is added successfully, false if student already exists in the database
     */
     ...
     * @return true if new Course is added successfully, false if course already exist in the database
     */
     ...
     * @return true of changed successfully, false if new courseid already exists in the database
     */
    ...
    /**
     * Set the vacancy limit to an index
     * Can increase the vacancy limit of the index, which will dequeue waitlisted students and confirm their positions and send notifications
     * Can decrease the vacancy limit as long the number of confirmed students is still within the limit
     * Cannot decrease the vacancy limit if the new vacancy limit is less than the number of confirmed students in the index
     * @param selectedIndex Index whose vacancy will be changed
     * @param newVacancyLimit new vacancy limit
     * @return true if successfully changed, false if new vacancy limit is less the the number of confirmed students in the index
     */
     ...
     * @return true if added successfully, false if index number already exists in the course
     */
     ...
     * @return true if added successfully, false if index new index number already exists in the course
     */
     ...
     * @return true if index is empty and can be dropped, false if index has confirmed students, index will not be dropped
     */
